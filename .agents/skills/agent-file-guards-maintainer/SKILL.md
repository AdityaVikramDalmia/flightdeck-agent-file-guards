---
name: agent-file-guards-maintainer
description: Maintain deprecated Agent File Guards's commands, documentation, examples, and release material as a public reference implementation. Use for changes in this repository.
---

# Maintain Agent File Guards
...
Maintain all three commands and their independent installation. Keep producer/read failures distinct from clean scans; static intake inventory is not a security certification.
